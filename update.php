...
#c1
{height:350px; width:900px; color:black; padding-left:-200px;margin-left:250px;}
#tech1
{height:120px; width:900px; background-color:black;padding-left:50px;opacity:.9;margin-left:0px; margin-top:36px;}
#nav
{
color:black;	
padding-top:7px;
...
<li><a href="#">Tree</a></li>
 ...
 <h3 align="center" align=center id="test1">Edit</h3>
 <hr>
<div id="c1">
<div id="nav">
<form name="myForm" action="" onsubmit="return validateForm()" method="post">
 <table border=1 height=80% width=80%><tr><td> <table align=center>
 <tr><td><table id="test2"><tr><td align="center">Emp.ID - 
 <?php
 echo $eid;
...
?></td></tr></table>
 ...
 <tr><td>Name</td><td><input type="text" placeholder="Full Name" name="name" id="n1" onkeypress="return( event.charCode >64 && event.charCode < 91 || event.charCode > 96 && event.charCode < 123)"></td></tr>
  <tr><td>Designation</td><td><input list="browsers" placeholder="Designation" name="Designation" id="n2"></td><tr>
  ...
  <tr><td>Manager</td><td>
  <select required="required" id="n3"   name="manager">
...
$sql = "update emp_details set employee_Name='$Name',employee_Designation='$Designation',reporting_Manager='$Manager' where emp_id='$eid'";
